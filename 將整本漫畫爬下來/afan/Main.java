    ...
    public static void main(String[] args) {
        ...
        for(int j=1;j<1000;++j) {
            ...
            for (int index = 0; index < 100; index += 10) {
                ...
                //把需要的資料硬拉出來
                int left = pageXml.indexOf(".html\">");
                int right = pageXml.indexOf("\" id=\"mhpic\"");
                StringBuilder jpg = new StringBuilder();
                jpg.append(pageXml, left + 64, right - 4);
...
//                System.out.println("jpg"+jpg);
                ...
                mid.append(pageXml, left + 56, left+64);

                for (int i = 0; i < 10; ++i) {
                    reptileThread reptilethread = new reptileThread();
                    reptilethread.setURL(jpgWeb+mid, Integer.parseInt(String.valueOf(jpg)) + i, index + i + 1,SaveFilePath);
                    reptilethread.start();
